...
try {
    ...
    if ($metodo == "ObterNCMs") {
        ...
        if (ObterNCMs($handle, $ffi, $resultado) != 0) {
            exit;
        }
    ...
    if ($metodo == "BaixarLista") {
        ...
        if (BaixarLista($handle, $ffi, $_POST['cNomeArquivo'], $resultado) != 0) {
            exit;
        }
    }
    ...
    if ($metodo == "BuscarPorCodigo") {
        ...
        if (BuscarPorCodigo($handle, $ffi, $_POST['cNCM'], $resultado) != 0) {
            exit;
        }
    }
    ...
    if ($metodo == "BuscarPorDescricao") {
        ...
        if (BuscarPorDescricao($handle, $ffi, $_POST['cDesc'], $_POST['nTipo'], $resultado) != 0) {
            exit;
        }
    }
    ...
    if ($metodo == "Validar") {
        ...
        if (Validar($handle, $ffi, $_POST['cNCM'], $resultado) != 0) {
            exit;
        }
    }
