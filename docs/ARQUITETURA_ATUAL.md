...
No modulo `NFe`, a operacao `consulta-cadastro` ja foi promovida para um desenho mais completo, com DTO especifico, atributos de validacao e provider proprio.
