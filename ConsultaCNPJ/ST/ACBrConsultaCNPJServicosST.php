...
include 'ACBrConsultaCNPJST.php';
...
try {
    ...
    if ($metodo == "salvarConfiguracoes") {
        ...
        if (ConfigGravarValor($ffi, "ConsultaCNPJ", "Provedor", $_POST['prov']) != 0) exit;
        if (ConfigGravarValor($ffi, "ConsultaCNPJ", "Usuario", $_POST['usuario']) != 0) exit;
        if (ConfigGravarValor($ffi, "ConsultaCNPJ", "Senha", $_POST['senha']) != 0) exit;

        if (ConfigGravar($ffi, $iniPath) != 0) exit;
    ...
    if ($metodo == "carregarConfiguracoes") {
        ...
        if (ConfigLerValor($ffi, "ConsultaCNPJ", "Usuario", $usuario) != 0) exit;
        if (ConfigLerValor($ffi, "ConsultaCNPJ", "Senha", $senha) != 0) exit;
        if (ConfigLerValor($ffi, "ConsultaCNPJ", "Provedor", $provedor) != 0) exit;
    ...
    if ($metodo == "Consultar") {
        ...
        $resultado = Consultar($ffi, $_POST['cnpj'], $iniContent);
