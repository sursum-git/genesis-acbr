...
${o?ge({messages:e,hasGroups:l,columns:u,groups:d,ns:f}):``}\
<li class="k-item k-clear-wrap">\
<ul class="k-listgroup k-listgroup-flush">\
<li class="k-listgroup-item">\
<span class="k-link k-label k-clear" title="${e.clear}" aria-label="${e.clear}">\
${r(e.clear)}\
</span></li></ul></li></ul></div></div>`,ve=O.extend({init:function(e,t){var n=this;O.fn.init.call(n,e,t),n._createCheckBoxes(),n.element.on(`click`+T,`li.k-item:not(.k-separator):not(.k-disabled):not(:has(.k-switch))`,`_click`)},events:[g],_click:function(t){var n=this;if(e(t.target).is(`[type=checkbox]`)||t.preventDefault(),e(t.target).hasClass(`k-clear`)){n._cancelChanges(!0);return}if(e(t.target).hasClass(`k-filterable`)){n._cancelChanges(!0),n.trigger(g,{item:t.currentTarget});return}n._updateSelectedItems(t.currentTarget)},_updateSelectedItems:function(t){var n=this,r=e(t),i=n.options.columnMenu.view.state||{columns:{}},a=r.prop(`id`);if(!r.hasClass(`k-filter-item`)){if(i[a]?i[a]=!1:i[a]=!0,r.hasClass(`k-sort-asc`)||r.hasClass(`k-sort-desc`)){var o,s,c;r.hasClass(`k-sort-asc`)?(o=`asc`,s=n.element.find(`.k-sort-desc`)):(o=`desc`,s=n.element.find(`.k-sort-asc`)),c=s.prop(`id`),o===i.initialSort&&!r.hasClass(`k-selected`)&&(i[a]=!1),i[c]&&(i[c]=!1),s.removeClass(u)}r.hasClass(u)?r.removeClass(u):r.addClass(u)}},_cancelChanges:function(e){var t=this,n=t.options.columnMenu,r=n.view,i=(r.state||{columns:{}}).columns;if(t.element.find(`.`+u).removeClass(u),n.refresh(),e){var a=[];for(var o in i)if(i.hasOwnProperty(o)&&i[o]===!0){var s=r.element.find(`#`+o);a.push(s[0])}for(var c=a.length-1;c>=0;c--)t.trigger(g,{item:a[c]});n.options.hasLockableColumns&&n._updateLockedColumns(),n.options.hasStickableColumns&&n._updateStickyColumns(),n.options.reorderable&&n._updateReorderColumns(),n.options.groupable&&n._updateGroupColumns()}t.options.columnMenu.view.state={columns:{}}},_applyChanges:function(){var e=this,t=e.options.columnMenu.view,n=t.state||{columns:{}};for(var r in n)if(n.hasOwnProperty(r)&&r!==`initialSort`&&r!==`columns`&&n[r]===!0){var i=t.element.find(`#`+r);i.hasClass(u)?i.removeClass(u):i.addClass(u),e.trigger(g,{item:i[0]})}},_createCheckBoxes:function(){var e=this;e.element.find(`.k-columns-item`).find(`[type='checkbox']`).kendoSwitch({messages:{checked:``,unchecked:``},change:function(t){var n=t.sender.element.closest(`.k-item`),r=e.options.columnMenu.view.state||{columns:{}},i=n.prop(`id`);r.columns[i]?r.columns[i]=!1:r.columns[i]=!0,e.trigger(g,{item:n})}})},_destroyCheckBoxes:function(){for(var e=this.element.find(`.k-columns-item`).find(`[type='checkbox']`),t,n=0;n<e.length;n++)t=e.eq(n).data(`kendoSwitch`),t&&t.destroy()},close:function(){this.options.pane.navigate(``)},destroy:function(){var e=this;O.fn.destroy.call(e),e.element.off(T),e._destroyCheckBoxes()}});i.plugin(L)})(window.kendo.jQuery);var u=kendo;e.__meta__=l,e.default=u});
