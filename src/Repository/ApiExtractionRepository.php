...
final class ApiExtractionRepository
{
    ...
    private function ensureSchema(): void
    {
        ...
        $statements = [
            ...
            "ALTER TABLE t99007 ADD COLUMN IF NOT EXISTS c_documento_consulta varchar(60)",
            "ALTER TABLE t99007 ALTER COLUMN documento_consulta TYPE varchar(60)",
            "ALTER TABLE t99007 ALTER COLUMN c_documento_consulta TYPE varchar(60)",
